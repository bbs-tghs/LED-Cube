...
/** 
 @brief Die Funktion spiegelt das übergebene Bitmuster.
		Bit 7 wird zu Bit 0, Bit 6 zu Bit 1 usw.
		Das wird erforderlich, wenn man die Kabel zwischen Multiplexer-Ausgang 
		und LEDs schön in immer gleicher Farbfolge an die LEDs anlötet, 
		um dann festzustellen, dass die Reihenfolge der Bits am anderen Platinenrand
		genau umgedreht ist. Selbstverständlich hat man dann keine neuen 4 Kabelstücke
		mit Stecker zur Hand :-) 
		Naja, bei der Folgeversion mal korrigieren
		
		siehe: https://www.mikrocontroller.net/topic/24117?goto=new#new 
		und:   https://www.mikrocontroller.net/articles/AVR-GCC-Tutorial/Assembler_und_Inline-Assembler
